...
df_past |> 
  ...
  arrow::write_dataset('NOAA/noaa_past', partitioning = c('site_id'))


noaa_past <- arrow::open_dataset('NOAA/noaa_past') |> 
  collect()
...
df_future |> 
  dplyr::filter(reference_datetime == forecast_date,
                ...
                variable %in% variables) |> 
  arrow::write_dataset('NOAA/noaa_future', partitioning = c('site_id'))

noaa_future <- arrow::open_dataset('NOAA/noaa_future') |> 
  collect()
